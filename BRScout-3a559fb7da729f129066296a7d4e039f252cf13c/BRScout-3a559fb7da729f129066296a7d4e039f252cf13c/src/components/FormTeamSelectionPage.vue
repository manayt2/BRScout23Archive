...
function loadTBAData() {
  tba.load("2023cthar", "teams").then(value => updateStatus($$(teamsLoadStatus), $$(teams), value));
  tba.load("2023cthar", "matches").then(value => updateStatus($$(matchesLoadStatus), $$(matches), value));
}
</script>
